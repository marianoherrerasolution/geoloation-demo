...
func Init() *router.Router {
	...
	rV2.GET("/u/restrictions/{id}/histories", authToken(restrictionsapi.Histories, "member"))
	rV2.GET("/u/restrictions/{id}/analytic", authToken(restrictionsapi.Analytic, "member"))
	...
	rV2.GET("/restrictions/{id}/histories", authToken(restrictionsapi.Histories, "admin"))
	rV2.GET("/restrictions/{id}/analytic", authToken(restrictionsapi.Analytic, "admin"))
