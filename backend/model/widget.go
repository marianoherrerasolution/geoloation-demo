...
type Widget struct {
	...
	Active          bool           `gorm:"column:active;index:idx_widget_active" json:"active"`
	...
	ProductIDs      pq.StringArray `gorm:"column:product_ids;type:text[];index:idx_widget_product_ids" json:"product_ids"`
...
func (u *Widget) GetProductIDs() []string {
	return u.ProductIDs
}

func (u *Widget) GetRestrictionIDs() []string {
